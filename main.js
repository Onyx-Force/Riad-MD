...
mobile: MethodMobile, 
browser: opcion == '1' ? ['𝐑𝐢𝐚𝐝-𝐌𝐝', '𝐎𝐧𝐢𝐱', '2.0.0'] : methodCodeQR ? ['𝐑𝐢𝐚𝐝-𝐌𝐝', '𝐎𝐧𝐢𝐱', '2.0.0'] : ['Ubuntu', 'Chrome', '110.0.5585.95'],
auth: {
creds: state.creds,
...
global.reloadHandler = async function(restatConn) {
  ...
  conn.welcome = '@user 𝔹𝕖𝕟𝕧𝕖𝕟𝕦𝕥𝕠/𝕒 𝕚𝕟 @subject'
conn.bye = '@user 𝕙𝕒 𝕒𝕓𝕓𝕒𝕟𝕕𝕠𝕟𝕒𝕥𝕠 𝕚𝕝 𝕘𝕣𝕦𝕡𝕡𝕠'
conn.spromote = '@user 𝕖̇ 𝕦𝕟 𝕤𝕦𝕡𝕣𝕖𝕞𝕠 💎'
conn.sdemote = '@user 𝕟𝕠𝕟 𝕖̇ 𝕡𝕚𝕦 𝕦𝕟 𝕤𝕦𝕡𝕣𝕖𝕞𝕠 😵'
