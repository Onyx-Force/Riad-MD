...
let handler = async (_0x534187, {
    ...
    const _0x2eaf59 = _0x3543, _0xd70231 = {
        ...
        }, _0x42342c = ('> ⚠︎ 𝒄𝒐𝒎𝒂𝒏𝒅𝒐 𝒏𝒐𝒏 𝒕𝒓𝒐𝒗𝒂𝒕𝒐. 𝑫𝒊𝒈𝒊𝒕𝒂 .𝒇𝒖𝒏𝒛𝒊𝒐𝒏𝒊 𝒑𝒆𝒓 𝒕𝒓𝒐𝒗𝒂𝒓𝒆 𝒊𝒍 𝒄𝒐𝒎𝒂𝒏𝒅𝒐 𝒈𝒊𝒖𝒔𝒕𝒐 𝒅𝒂 𝒔𝒄𝒓𝒊𝒗𝒆𝒓𝒆.')[_0x2eaf59(0x257)](), _0x25b2a5 = [{
                'title': null,
                'rows': [
                    {
    ...
    let _0xd796cd = {
            ...
            'message': {
                'locationMessage': {
                    ...
                    'jpegThumbnail': await (await _0xd70231['yploR'](fetch, 'https://qu.ax/KaDbk.png'))[_0x2eaf59(0x24a)](),
                    'vcard': _0x2eaf59(0x21a)
                }
            },
            'participant': _0xd70231[_0x2eaf59(0x212)]
...
function _0x3748() {
    const _0x23ea45 = [
        ...
        '1710212AIgTux',
        'antiCall',
        '❕️\x20𝐜𝐨𝐦𝐚𝐧𝐝𝐨\x20𝐢𝐧𝐞𝐬𝐢𝐬𝐭𝐞𝐧𝐭𝐞\x20',
        'gaxqC',
        'LOmGK',
        'antilinkhard',
        'DxnJN',
